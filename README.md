...
I work on **Saudi Arabia Standard Time (AST, UTC+3)**. Below is when I'm usually at the keyboard and
how fast you can expect an answer.

| Day | Hours (AST · UTC+3) | Hours (UTC) | Availability |
| :-- | :-- | :-- | :-- |
| **Sunday – Thursday** | `09:00 – 18:00` | `06:00 – 15:00` | 🟢 Core hours — meetings, pairing, reviews |
| **Sunday – Thursday** | `20:00 – 23:00` | `17:00 – 20:00` | 🔵 Side projects & open source |
| **Friday** | — | — | 🔴 Weekend — offline |
| **Saturday** | `flexible` | `flexible` | 🟡 Async only — I'll reply, just slower |
...
<!--
Coding-activity graph (how my week is actually spent).
This needs a free WakaTime account (https://wakatime.com) connected to your editor,
plus "Display code time publicly" enabled in your WakaTime profile settings.
Once that's done, delete this comment block and keep the image below:

<div align="center">
  <img src="https://github-readme-stats.vercel.app/api/wakatime?username=YOUR_WAKATIME_USERNAME&layout=compact&theme=tokyonight&hide_border=true&langs_count=8" alt="Weekly coding breakdown" />
</div>
-->
...
**BSc Computer Science** — Jubail Industrial College &nbsp;·&nbsp; `2021 – 2026`
...
My graduation project — an AI-powered web application that detects the severity of diabetic retinopathy from
...
<details>
<summary><b>🌐 Personal Portfolio — aalshehri.site</b> — <i>HTML · CSS · JavaScript · Netlify</i></summary>
...
<details>
<summary><b>🎨 Portfolio UI/UX Design</b> — <i>Figma</i></summary>
...
<!--
The github-readme-stats public instance (github-readme-stats.vercel.app) has been returning
503 DEPLOYMENT_PAUSED, so the stats and top-languages cards are left out to avoid broken images.
To bring them back once it's up again — or better, self-hosted via
https://github.com/anuraghazra/github-readme-stats — re-add:
...
<img height="180em" src="https://github-readme-stats.vercel.app/api/top-langs/?username=iignlu&layout=compact&theme=tokyonight&hide_border=true" />

Note: the top-languages card ranks by bytes of code in your repos, so it reads mostly
CSS/HTML/TypeScript — which undersells the React/Laravel/Python work you actually do.
-->
